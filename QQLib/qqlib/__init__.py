...
import os, hashlib, re, tempfile, binascii, base64, json
import rsa, requests
from . import tea
...
class QQ:
    ...
    def showCookie(self):
        ...
        # cookies = {
        #     "uin" : self.session.cookies['uin'],
        #     "skey" : self.session.cookies['skey'],
        #     "p_skey" : self.session.cookies['p_skey'],
        #     "p_uin" : self.session.cookies['p_uin'],

        #     # "pgv_pvi" : self.session.cookies['pgv_pvi'],
        #     "RK" : self.session.cookies['RK'],
        #     # "__Q_w_s__QZN_TodoMsgCnt" : self.session.cookies['__Q_w_s__QZN_TodoMsgCnt'],
        #     # "pac_uid" : self.session.cookies['pac_uid'],
        #     # "pgv_info" : self.session.cookies['pgv_info'],
        #     "pgv_pvid" : self.session.cookies['pgv_pvid'],
        #     "o_cookie" : self.session.cookies['o_cookie'],
        #     "pgv_si" : self.session.cookies['pgv_si'],
        #     "cpu_performance_v8" : self.session.cookies['cpu_performance_v8'],
        #     "ptui_loginuin" : self.session.cookies['ptui_loginuin'],
        #     "ptisp" : self.session.cookies['ptisp'],
        #     "ptcz" : self.session.cookies['ptcz'],
        #     "pt2gguin" : self.session.cookies['pt2gguin'],
        #     "pt4_token" : self.session.cookies['pt4_token'],
        #     "Loading" : self.session.cookies['Loading'],
        #     "qz_screen" : self.session.cookies['qz_screen'],
        #     "QZ_FE_WEBP_SUPPORT" : self.session.cookies['QZ_FE_WEBP_SUPPORT'],
        #     "rv2" : self.session.cookies['rv2'],
        #     "property20" : self.session.cookies['property20'],
        #     "qzspeedup" : self.session.cookies['qzspeedup']
        # }
